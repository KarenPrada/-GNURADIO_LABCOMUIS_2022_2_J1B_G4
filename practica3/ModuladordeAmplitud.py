...
class ModuladordeAmplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._OFFSET_range = Range(-1/Ka, 1/Ka, 1, 0, 200)
        ...
        self._GTX_win = RangeWidget(self._GTX_range, self.set_GTX, "ganancia del trasnmisor (GTX)", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.potencia_1 = potencia(
            l_vect=1024,
        )

        self.top_layout.addWidget(self.potencia_1)
        ...
        # Connections
        ##################################################
        self.connect((self.EnvolventeComplejaDSB_0, 0), (self.blocks_complex_to_real_0, 0))
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.potencia_1, 0))
        self.connect((self.blocks_complex_to_real_0, 0), (self.potencia_0, 0))
