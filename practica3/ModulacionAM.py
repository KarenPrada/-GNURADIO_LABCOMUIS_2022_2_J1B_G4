...
# Title: modulador de amplirud Grupo J1B Subgrupo G4
...
class ModulacionAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "modulador de amplirud Grupo J1B Subgrupo G4", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("modulador de amplirud Grupo J1B Subgrupo G4")
        ...
        self._fm_win = RangeWidget(self._fm_range, self.set_fm, "frecuenca del mensaje", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._GTX_win = RangeWidget(self._GTX_range, self.set_GTX, "ganancia trasmisor", "counter_slider", float, QtCore.Qt.Horizontal)
