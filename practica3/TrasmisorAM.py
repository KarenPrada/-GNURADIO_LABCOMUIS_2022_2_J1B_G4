...
# Title: TrasmisorAM
# Author: Andres Cañizares  Karen Prada
...
from potencia import potencia  # grc-generated hier_block



from gnuradio import qtgui

class TrasmisorAM(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "TrasmisorAM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("TrasmisorAM")
        ...
        self.settings = Qt.QSettings("GNU Radio", "TrasmisorAM")
        ...
        # Blocks
        ##################################################
        self._fm_range = Range(100, 20000, 100, 1000, 200)
        ...
        self._dc_range = Range(-2, 2, 100e-6, 1, 200)
        ...
        self._Ka_win = RangeWidget(self._Ka_range, self.set_Ka, "coeficiente de ka", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._Ka_win)
        self._Am_range = Range(0, 1, 100e-6, 100e-3, 200)
        ...
        self.potencia_0 = potencia(
            l_vect=1024,
        )

        self.top_layout.addWidget(self.potencia_0)
        ...
        # Connections
        ##################################################
        self.connect((self.EnvolventeComplejaDSB_0, 0), (self.blocks_throttle_0, 0))
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.potencia_0, 0))
...
def main(top_block_cls=TrasmisorAM, options=None):
