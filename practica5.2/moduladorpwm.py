...
# Title: modulador pwm
# Author: karen pranda Andres cañizares
...
class moduladorpwm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._C_range = Range(-1, 1, 0.1, 0, 200)
        self._C_win = RangeWidget(self._C_range, self.set_C, "C", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_CONST_WAVE, fm, C, 0, 0)
    ...
    def set_C(self, C):
        self.C = C
        self.analog_sig_source_x_0.set_amplitude(self.C)
