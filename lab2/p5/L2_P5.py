...
class L2_P5(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab2_p5")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab2_p5")
        ...
        self.settings = Qt.QSettings("GNU Radio", "L2_P5")
        ...
        self.analog_sig_source_x_2 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 4000, 1, 0, 0)
...
def main(top_block_cls=L2_P5, options=None):
