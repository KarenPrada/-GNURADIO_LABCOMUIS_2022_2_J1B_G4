...
class L2_p3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "l2_p3")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("l2_p3")
        ...
        self.settings = Qt.QSettings("GNU Radio", "L2_p3")
        ...
        self._samp_rate_win = RangeWidget(self._samp_rate_range, self.set_samp_rate, 'frecuencai de muestreo', "counter_slider", float)
        self.top_grid_layout.addWidget(self._samp_rate_win)
        self._fc_range = Range(100, 21000, 10, 1500, 200)
        self._fc_win = RangeWidget(self._fc_range, self.set_fc, 'frecuancai central', "counter_slider", float)
        self.top_grid_layout.addWidget(self._fc_win)
        self._f_corte_range = Range(100, 21000, 10, 1500, 200)
        self._f_corte_win = RangeWidget(self._f_corte_range, self.set_f_corte, 'frecuancia de corte', "counter_slider", float)
        ...
        self.low_pass_filter_0 = filter.interp_fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('D:\\Usuario\\Downloads\\labachata_manuelturizo.wav', True)
...
def main(top_block_cls=L2_p3, options=None):
